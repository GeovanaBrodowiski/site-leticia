export const perguntas = [
    {
        enunciado: "como a fome afeta a sociedade?"
        alternativas: [
            {
                texto:"Dentre as transformações ocasionadas podemos citar a diminuição da renda e do poder de compra e o aumento da pobreza e das desigualdades sociais no território nacional.Além disso, houve o aprofundamento de problemas que já estavam em curso,como foi o caso do desemprego.
                afirmacao: [
    ...
    {
        enunciado:"quais são os impactos da desigualdade social na sociedade?"
        alternativas: [
            {
                texto: " A desigualdade social pode resultar em uma série de problemas,incluindo aumento da criminalidade, falta decoesão social,aumento da pobreza e exclusão social,
                 além de perpetuar ciclos de desvantagem e marginalização.",
                afirmacao: [
